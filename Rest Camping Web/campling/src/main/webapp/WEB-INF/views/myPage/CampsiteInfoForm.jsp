...
<div class="info-input">
    <div class="" data-option="on">
            ...
            <div class="option-input-list">
                ...
                <div class="option-wrap">
                    <div class="input-wrap">
                        ...
                        <textarea class="info-input__input" name="campsiteIntroduction" cols="50" rows="20" style="height: 80px; resize: none;"></textarea>
                    </div>
                </div>
                ...
                <div class="option-wrap">
                    <div class="input-wrap">
                        ...
                        <textarea class="info-input__input" name="campsiteNotice" cols="50" rows="20" style="height: 80px; resize: none;"></textarea>
                    </div>
                </div>
        ...
        <div class="info-input__row reservation-info">
                ...
                <div style="display : flex; flex-direction: column">
                    <div class="option-wrap">
                        <div class="input-wrap">
                            ...
                            <input type="number" name = "pricePerExcessCar" class="info-input__input" placeholder="차량 초과 비용 입력">
                        </div>
                    </div>
                    ...
                    <div class="option-wrap">
                        <div class="input-wrap">
                            ...
                            <input type="number" name = "pricePerExcessPerson" class="info-input__input" placeholder="인원 초과 비용 입력">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class = "wrap-column normal room">
                    ...
                    <div class = "wrap-row" style="display : flex; flex-direction: row">
                        ...
                        <div style="display : flex; flex-direction: column; margin-left: 70px">
                            ...
                            <div class="option-wrap">
                                <div class="input-wrap">
                                    <input type="number" class="info-input__input"  name = "baseHeadCnt" placeholder="기준 인원 입력">
                                </div>
                            </div>

                            <div class="option-wrap">
                                <div class="input-wrap">
                                    <input type="number" class="info-input__input" name = "baseNumCars" placeholder="기준 차량 입력">
                                </div>
                            </div>

                            <div class="option-wrap">
                                <div class="input-wrap">
                                    <input type="number" class="info-input__input" name = "maxHeadCnt" placeholder="최대 인원 입력">
                                </div>
                            </div>

                            <div class="option-wrap">
                                <div class="input-wrap">
                                    <input type="number" class="info-input__input" name = "numRemains" placeholder="남은 방 개수 입력">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class = "wrap-column normal mealKit">
                    ...
                    <div class = "wrap-row">
                        ...
                        <div style="display : flex; flex-direction: column; margin-left: 70px">
                            ...
                            <div class="option-wrap">
                                <div class="input-wrap">
                                    <input type="number" class="info-input__input" name = "numRemains" placeholder="남은 개수 입력">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="display : flex; flex-direction: column; margin-left: 70px">
                            ...
                            <div class="option-wrap">
                                <div class="input-wrap">
                                    ...
                                    <textarea class="info-input__input" name="desc" cols="30" rows="10" style="resize: none;"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="display : flex; flex-direction: column; margin-left: 70px">
                            ...
                            <div class="option-wrap">
                                <div class="input-wrap">
                                    ...
                                    <textarea class="info-input__input" name = "desc" name="" cols="30" rows="10" style="resize: none;"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
